...
export default function FAQPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white relative overflow-hidden">
            ...
            {/* Floating Orbs */}
            <div className="fixed top-20 left-10 size-72 bg-purple-600/10 rounded-full blur-3xl animate-pulse" />
            <div className="fixed bottom-20 right-10 size-96 bg-violet-600/10 rounded-full blur-3xl animate-pulse delay-1000" />
            <div className="fixed top-1/2 left-1/2 size-80 bg-indigo-600/5 rounded-full blur-3xl animate-pulse delay-500" />
