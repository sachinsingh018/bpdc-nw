          ...
          <div className="border border-white/10 bg-white/80 backdrop-blur-xl p-8 md:p-12 rounded-3xl shadow-2xl">
            ...
            {[
              ...
              <section className="mb-10" key={index}>
                <h2 className="text-xl md:text-2xl font-semibold text-violet-600 mb-3">
                  {section.title}
                </h2>

                {section.content && !section.link && (
                  <p className="text-base leading-relaxed text-zinc-700">{section.content}</p>
                )}

                {section.list && (
                  <ul className="list-disc list-inside text-zinc-700 space-y-2 text-base">
                ...
                {section.link && (
                  <p className="text-base leading-relaxed text-zinc-700">
                    ...
                    <a
                      ...
                      className="text-violet-600 underline hover:text-purple-600 transition"
                    >
                      {section.link}
                    </a>{' '}
